...
void	sort_three_top(t_list **stack, t_list **stack2)
{
	...
	{
		sa(stack); pb(stack, stack2); sa(stack); pa(stack, stack2);
	}
	else if (first < second && second > third && first > third)
	{
		pb(stack, stack2); sa(stack); pa(stack, stack2); sa(stack);
	}
	else if (first < second && second > third && first < third)
	{
		pb(stack, stack2); sa(stack); pa(stack, stack2);
	}
	else if (first > second && second > third)
	{
		sa(stack); pb(stack, stack2); sa(stack); pa(stack, stack2); sa(stack);
	}
}
